 ...
 * @author Andrio
 */
public class Visualizar_Codigos extends javax.swing.JInternalFrame {

    DefaultTableModel dt = new DefaultTableModel(
            new Object[][]{},
            new Object[]{"ID","Ling","Assunto","Codigo"});
    
    public Visualizar_Codigos() {
        initComponents();
        preencher();
    }
     ...
     private void preencher(){
        ...
        try {   
            ...
            dad = tb.buscarCodigos();

            for (int i = 0; i < dad.size(); i++) {
                dt.addRow(new String[]{
                    String.valueOf(dad.get(i).getIdCodigo()),
                    String.valueOf(dad.get(i).getLing()),
                    String.valueOf(dad.get(i).getAssunto()),
                    String.valueOf(dad.get(i).getCodigo())
                });
            }
            dados.setModel(dt);
    ...
    private void alterar(){
           try {
            ...
            busc.get(i).setCodigo(codigo.getText());
            
            p.alterar_Cod(busc.get(i));
    ...
    private void excluir() {
        ...
        try {
           servico tb = ServicosFactory.getCodigoServicos();
            ...
            prod = tb.buscarCodigos();

            int i = dados.getSelectedRow();

            codigosDAO p = new codigosDAO();

            p.deletar_Cod(prod.get(i));
